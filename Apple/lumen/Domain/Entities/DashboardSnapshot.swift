...
struct DashboardSnapshot: Sendable, Codable, Hashable {
    ...
    /// Optional per-category mirror lines generated by the morning synthesis.
    var insights: [DashboardCategory: String]?
    ...
    init(
        ...
        insights: [DashboardCategory: String]? = nil
    ) {
        self.date = date
        self.mood = mood
        self.energy = energy
        ...
        self.insights = insights?.isEmpty == true ? nil : insights
    }
}
